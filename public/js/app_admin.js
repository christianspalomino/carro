...
var api_search_autocomplete = new Vue({
  //Vuejs variable api_search_autocomplete va ser instancia de vuejs
  el: '#api_search_autocomplete',
  //q recargue el id que viene de api_search_autocomplete
  data: {
    palabra_a_buscar: '',
    //variable dinamica palabra_a_buscar: 'Christians Palomino',
  ...
  methods: {
    autoComplete: function autoComplete() {
      ...
      if (this.palabra_a_buscar.length > 2) {
        ...
        axios.get('/api/autocomplete', //y q enviemos por parametros palabraabuscar y sera = a this.palabra_a_buscar
        {
          params: {
...
/***/ "./resources/js/admin/apicategoria.js":
/*!********************************************!*\
  !*** ./resources/js/admin/apicategoria.js ***!
  \********************************************/
/*! no static exports found */
...
var apicategoria = new Vue({
  //Vuejs variable apicategoria va ser instancia de vuejs
  el: '#apicategoria',
  //q recargue el id que viene de apicategoria
  data: {
    //propiedad data y pasamos el primer objeto q es el nommbre
    nombre: '',
    //variable dinamica nombre: 'Christians Palomino',
    slug: '',
    //crear variable slug
  ...
  //crear funcion 
  computed: {
    //...cauando se ejecute esta funcion computed
    generarSlug: function generarSlug() {
      ...
      this.slug = this.nombre.trim().replace(expr, function (e) {
        return _char[e];
      }).toLowerCase(); //pasar un indice por la funcion (variable e) funtion(e)
  ...
  methods: {
    getCategory: function getCategory() {
      ...
      if (this.slug) {
        var url = '/api/categoria/' + this.slug; //crear variable url sera = a api/category
        ...
        axios.get(url).then(function (response) {
          ...
          _this.div_mensajeslug = response.data; // console.log(response.data);
          //si 
          ...
          if (_this.div_mensajeslug == "Slug Disponible") {
            ...
            //de lo contrario llamar a badge badge danger
            _this.div_clase_slug = 'badge badge-danger';
            _this.deshabilitar_boton = 1;
          }

          _this.div_aparecer = true; //this.aparecer sera true mostrar
          //nueva funcionalidad 
          ...
          if (document.getElementById('editar')) {
            ...
            if (document.getElementById('nombretemp').innerHTML === _this.nombre) {
              ...
              _this.deshabilitar_boton = 0;
              _this.div_mensajeslug = ''; //mensaje borralo

              _this.div_clase_slug = ''; //en blanco 

              _this.div_aparecer = false; //desapaarce div
            }
          }
        });
...
/***/ "./resources/js/admin/apiproducto.js":
/*!*******************************************!*\
  !*** ./resources/js/admin/apiproducto.js ***!
  \*******************************************/
/*! no static exports found */
...
var apiproducto = new Vue({
  //Vuejs variable apiproducto va ser instancia de vuejs
  el: '#apiproducto',
  //q recargue el id que viene de apiproducto
  data: {
    //propiedad data y pasamos el primer objeto q es el nommbre
    nombre: '',
    //variable dinamica nombre: 'Christians Palomino',
  ...
  methods: {
    eliminarimagen: function eliminarimagen(imagen) {
      ...
      Swal.fire({
        ...
        //imagen->id pero en js es imagen.id
        ...
        if (result.value) {
          var url = '/api/eliminarimagen/' + imagen.id; //crear variable url sera = a api/product
          //metodo get, consultar url q esta en la variable url... .then (si se ejecuto correctamente q haga lo siguienre..response=>)
    ...
    getProduct: function getProduct() {
      ...
      //si existe informacion en el slug, entonces ejecuta todo eso
      if (this.slug) {
        var url = '/api/producto/' + this.slug; //crear variable url sera = a api/product
        //metodo get, consultar url q esta en la variable url... .then (si se ejecuto correctamente q haga lo siguienre..response=>)
    ...
    mounted: function mounted() {
      ...
      if (data.editar == 'Si') {
        ...
        this.stock_disponible = data.datos.stock_disponible; //se desabilite
...
if (document.getElementById('apicategoria')) {
  __webpack_require__(/*! ./admin/apicategoria */ "./resources/js/admin/apicategoria.js"); //requiero este archivo		

}

if (document.getElementById('apiproducto')) {
  __webpack_require__(/*! ./admin/apiproducto */ "./resources/js/admin/apiproducto.js"); //requiero este archivo		
...
if (document.getElementById('api_search_autocomplete')) {
  __webpack_require__(/*! ./admin/api_search_autocomplete */ "./resources/js/admin/api_search_autocomplete.js"); //requiero este archivo		
...
var confirmareliminar = new Vue({
  //Vuejs variable apicategory va ser instancia de vuejs
  el: '#confirmareliminar',
  //q recargue el id que viene de apicategory
  data: {
    //propiedad data y pasamos el primer objeto q es el nommbre
    urlaeliminar: ''
  },
  ...
  methods: {
    deseas_eliminar: function deseas_eliminar(id) {
      ...
      this.urlaeliminar = document.getElementById('urlbase').innerHTML + '/' + id; // alert(this.urleliminar);
      // jquery
...
module.exports = __webpack_require__(/*! C:\laragon\www\nhl-prueba\resources\js\app_admin.js */"./resources/js/app_admin.js");
